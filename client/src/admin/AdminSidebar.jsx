...
const AdminSidebar = () => {
  ...
  const menuItems = [
    ...
    { path: "/admin/low-stock", text: "Low Stock", icon: <FaExclamationTriangle /> },
    { path: "/admin/customers", text: "Customers", icon: <FaUsers /> },
    { path: "/products",text:"Shop", icon: <FaHome size={20} /> },
  ];
    ...
    <div className="admin-sidebar-container d-flex flex-column vh-100 p-3">
      ...
      <div className="mt-auto">
        <Nav className="flex-column">
          <Nav.Link
            onClick={() => navigate("/")}
            className="sidebar-link sidebar-link-bottom d-flex align-items-center small"
          >
            <FaGlobe className="me-2" /> Back to Website
          </Nav.Link>
          <Nav.Link
            onClick={handleLogout}
            className="sidebar-link sidebar-link-bottom d-flex align-items-center small text-danger"
          >
