...
// import { Container, Row, Col, Spinner } from "react-bootstrap"; // Import layout components
// import api from "../utils/api";
// import Card from "./Card";
// import LeftSidebar from "./LeftSidebar"; // Import the sidebar
...
//       <Row>
//         {/* --- Sidebar Column --- */}
//         <Col md={2} lg={2} className="bg-light vh-100 p-0 shadow-sm sticky-top">
//           <LeftSidebar />
//         </Col>
...
//             ) : (
//               <Row>
//                 {/* Map through products and wrap each card in a Col for proper grid layout */}
//                 {data.map((item) => (
//                   <Col key={item._id} sm={6} lg={4} xl={3} className="mb-4 d-flex align-items-stretch">
//                     <Card
//                       _id={item._id}
//                       image={item.image}
//                       title={item.name}
...
//                       price={item.price}
//                       rating={item.rating}
//                       link="#" // You would change this link to `/product/${item._id}`
//                       fromcomp="product"
//                     />
//                   </Col>
//                 ))}
...
// import React, { useState, useEffect } from "react";
// import { Container, Row, Col, Spinner, Alert } from "react-bootstrap"; // Added Alert for error display
// import api from "../utils/api";
// import Card from "./Card";
...
//                       price={item.price}
//                       rating={item.rating}
//                       link={`/products/${item._id}`} // Updated link for navigation
//                       fromcomp="product"
//                     />
//                   </Col>
//                 ))}
...
import "../stylesheets/ProductListPage.css"; // Import CSS for new styles
...
const ProductList = () => {
  ...
  const [showFilterCanvas, setShowFilterCanvas] = useState(false); // State for mobile filter menu
