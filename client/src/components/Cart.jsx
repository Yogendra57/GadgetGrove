...
// import BottomNavbar from "./BottomNavbar"; // Import the mobile bottom navbar
...
//         {/* Add 'desktop-sidebar' class to hide on mobile */}
//         <Col md={2} lg={2} className="desktop-sidebar bg-light vh-100 p-0 shadow-sm sticky-top">
//           <LeftSidebar />
//         </Col>

//         {/* --- Cart Content Column --- */}
//         {/* Add 'main-content-area' class for mobile padding adjustment */}
